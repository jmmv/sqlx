...
//! To that end, this module implements a `TcpStreamWrapper` stream that can be interposed
...
pub(crate) struct TcpStreamWrapper<S>
where
...
impl<S> From<S> for TcpStreamWrapper<S>
where
    S: AsyncRead + AsyncWrite + Shutdown + Unpin,
{
    fn from(t: S) -> Self {
...
impl<S> Shutdown for TcpStreamWrapper<S>
where
    S: AsyncRead + AsyncWrite + Shutdown + Unpin,
{
...
impl<S> AsyncRead for TcpStreamWrapper<S>
where
    S: AsyncRead + AsyncWrite + Shutdown + Unpin,
{
...
impl<S> AsyncWrite for TcpStreamWrapper<S>
where
    S: AsyncRead + AsyncWrite + Shutdown + Unpin,
{
    ...
    {
        if self.tls_wrapping {
            let (wrapped_buf, write_len) = TcpStreamWrapper::<S>::process_write(buf)?;
...
mod testutils {
    ...
    pub(crate) struct Checker {
        stream: TcpStreamWrapper<MockTcpStream>,
    }

    impl From<MockTcpStream> for Checker {
        fn from(stream: MockTcpStream) -> Checker {
            Checker { stream: TcpStreamWrapper::from(stream) }
        }
    }
...
mod tests {
    ...
    #[test]
    fn test_tcpstreamwrapper_read_passthrough_shorter_than_buffer() {
    ...
    #[test]
    fn test_tcpstreamwrapper_read_passthrough_longer_than_buffer() {
        let stream = MockTcpStream::default()
    ...
    #[test]
    fn test_tcpstreamwrapper_read_passthrough_to_tls_transitions() {
        let stream = MockTcpStream::default()
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_packets_fit_in_buffer() {
        let stream = MockTcpStream::default()
            .add_golden_read([
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_one_by_one() {
        let stream = MockTcpStream::default()
            .add_golden_read([
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_packet_size_exceeds_one_byte() {
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_buffer_shorter_than_payload() {
        let stream = MockTcpStream::default()
            .add_golden_read([
                0x12, 0x01, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x00, // TDS header.
                0x99, 0x98, 0x97, // TLS opaque payload.
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_buffer_shorter_than_header() {
        let stream = MockTcpStream::default()
            .add_golden_read([
                0x12, 0x01, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x00, // TDS header.
                0x99, 0x98, 0x97, // TLS opaque payload.
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_invalid_header_type() {
        let stream = MockTcpStream::default()
            .add_golden_read([
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_truncated_header() {
        let stream = MockTcpStream::default()
            .add_golden_read([
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_empty_payload() {
        let stream = MockTcpStream::default()
            .add_golden_read([
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_invalid_tds_length() {
        let stream = MockTcpStream::default()
            .add_golden_read([
    ...
    #[test]
    fn test_tcpstreamwrapper_read_tls_truncated_payload() {
        let stream = MockTcpStream::default()
            .add_golden_read([
    ...
    #[test]
    fn test_tcpstreamwrapper_write_passthrough() {
        let stream = MockTcpStream::default();
        Checker::from(stream)
    ...
    #[test]
    fn test_tcpstreamwrapper_write_passthrough_to_tls_transitions() {
        let stream = MockTcpStream::default();
        Checker::from(stream)
    ...
    #[test]
    fn test_tcpstreamwrapper_write_tls_handshake() {
        let stream = MockTcpStream::default();
        Checker::from(stream)
            .set_wrap_tls(true)
            .check_write(6, [
    ...
    #[test]
    fn test_tcpstreamwrapper_write_tls_changecipherspec() {
        let stream = MockTcpStream::default();
        Checker::from(stream)
            .set_wrap_tls(true)
            .check_write(6, [
    ...
    #[test]
    fn test_tcpstreamwrapper_write_tls_payload_longer_than_tls_length() {
        let stream = MockTcpStream::default();
        Checker::from(stream)
            .set_wrap_tls(true)
            .check_write(7, [
    ...
    #[test]
    fn test_tcpstreamwrapper_write_tls_too_short() {
        let stream = MockTcpStream::default();
        Checker::from(stream)
            .set_wrap_tls(true)
    ...
    #[test]
    fn test_tcpstreamwrapper_write_tls_payload_max_length() {
        let mut exp_buf = vec!();
        let mut buf = vec!();
    ...
    #[test]
    fn test_tcpstreamwrapper_write_tls_payload_too_long() {
        let stream = MockTcpStream::default();
        Checker::from(stream)
            .set_wrap_tls(true)
    ...
    #[test]
    fn test_tcpstreamwrapper_write_tls_payload_shorter_than_tls_length() {
        let stream = MockTcpStream::default();
        Checker::from(stream)
            .set_wrap_tls(true)

...
use crate::mssql::connection::tls::TcpStreamWrapper;
...
pub(crate) struct MssqlStream {
    inner: BufStream<MaybeTlsStream<TcpStreamWrapper<TcpStream>>>,
...
impl Deref for MssqlStream {
    type Target = BufStream<MaybeTlsStream<TcpStreamWrapper<TcpStream>>>;
